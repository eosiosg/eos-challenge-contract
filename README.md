...
- Declaration: **[[eosio::action]] void create(const name &eos\_account, const binary\_extension\<std::string\> &eth\_address);**
...
- Declaration: **[[eosio::action]] void raw(const hex\_code &trx\_code, const binary\_extension\<eth\_addr\_160\> &sender);**
...
- Declaration: **[[eosio::action]] void simulate(const hex\_code &trx\_code, const binary\_extension\<eth\_addr\_160\> &sender);**
...
- Declaration: **[[eosio::on_notify("\*::transfer")]]
...
- Declaration: **[[eosio::action]] void withdraw(const name &eos_account, const asset &amount);**
...
- Declaration: **[[eosio::action]] void linktoken(const extended_symbol &contract);**
...
- Declaration: **[[eosio::action]] void log(const std::string &status\_code,
				 const std::string &output,
				 const std::string &from,
				 const std::string &to,
				 const std::string &nonce,
				 const std::string &gas\_price,
				 const std::string &gas\_left,
				 const std::string &gas\_usage,
				 ...
				 const std::string &eth\_emit\_logs
				);**
